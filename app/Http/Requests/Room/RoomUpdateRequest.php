...
class RoomUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', Rule::unique('rooms', 'name')->whereNull('deleted_at')->ignore($this->id)],
            ...
            'thumbnail' => ['sometimes', 'file', 'mimes:jpg,png,gif,jpeg'],
        ];
    ...
    public function messages()
    {
        return [
            ...
            'extra_bed_price.required' => 'Please fill extra bed price',
            ...
            'thumbnail.required' => 'Please fill Room Description',
            'thumbnail.mimes' => 'This room image must be JPG, PNG, GIF, JPEG',
        ];
    }
